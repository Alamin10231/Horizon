...
export const UpdateEmail: React.FC = () => {
  ...
  <div className="mt-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
    <div className="text-center md:text-left">
      ...
      <input className="bg-[#F8FBED] py-3 px-4 my-4" type="text" name="text" placeholder="Enter new mail address..." id="" />
    </div>
   
  </div>

  {/* Update Email */}
  <button className="mt-4 bg-green font-semibold  text-white px-6 md:px-8 py-2 rounded-full hover:bg-gray-800 text-sm md:text-base">
   <Link to="/confirmemail"> Send to verification code</Link>
  </button>
</div>
