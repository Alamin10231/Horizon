...
export const UserProfile: React.FC = () => {
  ...
  {/* Email Section */}
  <div className="mt-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
    <div className="text-center md:text-left">
      <h3 className="text-[#3F4919] font-medium text-2xl md:text-3xl mb-2">My Email Address</h3>
      <p className="flex items-center justify-center md:justify-start gap-2 text-[#20250C] text-lg md:text-2xl">
        <span className="text-[#99BA14] text-xl md:text-2xl bg-[#94B3161A] p-3 rounded-full">
          <IoMdMail />
        </span> 
        david@gmail.com
      </p>
    </div>
    <button className="bg-[#99BA14] text-white px-6 md:px-8 text-sm md:text-xl py-2 rounded-full hover:bg-[#233205]">
      My Order List
    </button>
  </div>

  {/* Update Email */}
  <button className="mt-4 bg-[#94B3161A] font-semibold text-[#99BA14] px-6 md:px-8 py-2 rounded-full hover:bg-gray-800 text-sm md:text-base">
   <Link to="/updatemail"> Update Email</Link>
  </button>
</div>
